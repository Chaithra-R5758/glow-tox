              ...
              <div className={'gift-card-inner-wrapper'}>
                ...
                <Modal
                  ...
                  <div className={'create-row'} style={{ display: 'flex', marginTop: 20 }}>
                    ...
                    <div className={" select-wrapper"}  >
                      <input
                        ...
                        disabled={!newGiftCard}
                        style={{
                          width: 140, backgroundColor: ' #E2E2E2', blockSize: 40, border: '0px', borderRadius: '5px', marginBottom: 30
                        }} />
                      <datalist id="type" >
                        <option>$</option>
                        <option>%</option>
                  ...
                  <Button loading={saveGiftcardLoading}
                    onClick={() => saveGiftcard()} className="save-btn" style={{ float: 'right', backgroundColor: '#5D72E9', color: 'white', borderRadius: '5px', padding: '0px 25px 0px 25px', marginTop: '-20px' }}>Save</Button>
                  {showError && <div style={{
                    color: 'red',
                    textAlign: 'center',
