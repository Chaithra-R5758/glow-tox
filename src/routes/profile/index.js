                        ...
                        <div className={'profile-card'} >
                            <Card >
                                ...
                                <div className={'img-card'}>
                                    <img src={response.user.profilePic ? response.user.profilePic : 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTElqQujDQxdUSZiRtY81HGprrV_jEvxBZ14Q&usqp=CAU'}
